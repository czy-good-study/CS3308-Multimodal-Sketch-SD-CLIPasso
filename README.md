# SD-CLIPasso: A Training-free Framework for Controllable Text-to-Sketch Generation
...
Here are some examples of sketches generated by our pipeline. The animations show the optimization process from initialization to the final result.

| Prompt: "a drawing of a bird" | Prompt: "a drawing of a horse" | Prompt: "a drawing of an apple" |
| :---: | :---: | :---: |
| ![Bird](SD_CLIPasso/results/a_drawing_of_a_bird_s64_style_realistic_full_body_centered_high_contra/evolution.gif) | ![Horse](SD_CLIPasso/results/a_drawing_of_a_horse_s64_style_realistic_full_body_centered_high_contra/evolution.gif) | ![Apple](SD_CLIPasso/results/a_drawing_of_an_apple_s64_style_realistic_full_body_centered_high_contra/evolution.gif) |

### Style Transfer Results
We also explored style transfer by conditioning the generation on different artistic styles.

> **Note:** The code for the style transfer feature (including style loss and adaptive stroke parameters) is located in the [`Sketch-Generation-with-Specific-Style`](https://github.com/czy-good-study/CS3308-Multimodal-Sketch-SD-CLIPasso/tree/Sketch-Generation-with-Specific-Style) branch.

![Style Transfer Results](SD_CLIPasso/results/sketch_with_different_style.jpg)
...
While our primary results are qualitative (see Gallery), we also provide a script to compute CLIP similarity scores to quantitatively measure the semantic alignment between the generated sketch and the text prompt.

Use `SD_CLIPasso/evaluate_sketch.py` to compute these metrics:
